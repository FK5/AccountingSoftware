...
@section('content')
  ...
  <form method="POST" class="row-6" action="{{route('users.store')}}">
    @csrf
    @method('POST')
    <div class="container">
      <div class="row">
        <div class="col-8">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @if($errors->has('gender'))is-invalid @endif" id="gender" name="gender"  aria-describedby="emailHelp">
