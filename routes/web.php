...
Route::middleware(['auth','isApproved'])->group(function () {
    ...
    Route::get('/companies/{company}/assign', [App\Http\Controllers\CompanyController::class, 'assign'])->name('companies.assign');
    Route::put('/companies/{company}/attach', [App\Http\Controllers\CompanyController::class, 'attachOfficer'])->name('companies.officers.attach');
    Route::put('/companies/{company}/detach', [App\Http\Controllers\CompanyController::class, 'detachOfficer'])->name('companies.officers.detach');
    //PRODUCTS ROUTES
